...
reject comments, commits, code, issue/discussion edits, and other
...
issues, pull requests, and discussions in this repository — and also applies
when an individual is officially representing the project in public spaces.

## Enforcement

This is a solo-maintained project without a private mailing address to
report to. Instances of abusive, harassing, or otherwise unacceptable
behavior may be reported by opening an issue in this repository. Reports
made this way are visible to other repository visitors; if that is a
concern, GitHub's own
[reporting abuse](https://docs.github.com/en/site-policy/content-removal-policies/github-abuse-and-inauthentic-activity-policy)
channels are an alternative for content that violates GitHub's own policies.

All maintainers are obligated to respect the privacy and security of the
reporter of any incident, to the extent that is possible in a public-issue
reporting flow.
